package com.project.moneyManager.MoneyManager.config;

import com.project.moneyManager.MoneyManager.security.JwtRequestFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors(Customizer.withDefaults()).csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth->auth.requestMatchers("/status","/health","/register","/activate","login")
                        .permitAll()
                        .anyRequest()
                        .authenticated())
